...
st.sidebar.subheader('Nuestra Problematica')
st.sidebar.write('La calidad deficiente del agua potable.')
st.sidebar.subheader('Nuestro Proposito')
...
st.sidebar.caption('Ashlie Salgueiro Moreno')
st.sidebar.caption('Karol Nayelli Navarro Luna')
